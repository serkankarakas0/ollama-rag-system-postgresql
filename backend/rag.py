...
def build_prompt(question: str, chunks: list[dict]) -> str:
    ...
    return (
        ...
        "ÖRNEK (fiyat karşılaştırması — 'en ucuz/en pahalı' gibi sorularda önce "
        "BAĞLAM'daki İLGİLİ TÜM fiyatları tek tek listele, sonra karşılaştır):\n"
        "BAĞLAM: \"Su - 50 TL\\nSoda - 75 TL\\nMeyveli Soda - 90 TL\"\n"
        "SORU: en ucuz içecek hangisi\n"
        "CEVAP: Fiyatlar: Su 50 TL, Soda 75 TL, Meyveli Soda 90 TL. En düşük fiyat "
        "Su'da, bu yüzden en ucuz içecek: Su - 50 TL.\n\n"
        "ŞİMDİ SIRA SENDE:\n"
        f"BAĞLAM:\n{context}\n\n"
        f"SORU: {question}\n\n"
        "CEVAP:"
